...
insert into public.teams (id, sport_id, name, city, abbreviation, primary_color, slug) values
  ...
  ('mlb-oak', 'MLB', 'Athletics', 'Sacramento', 'OAK', '#003831', 'oakland-athletics'),
...
insert into public.venues (id, sport_id, name, slug, city, state, capacity) values
  ...
  ('v-sofi', 'NFL', 'SoFi Stadium', 'sofi-stadium', 'Los Angeles', 'CA', 70240),
  ('v-att', 'NFL', 'AT&T Stadium', 'att-stadium', 'Dallas', 'TX', 80000),
  ('v-metlife', 'NFL', 'MetLife Stadium', 'metlife-stadium', 'New York', 'NJ', 82500),
  ('v-lambeau', 'NFL', 'Lambeau Field', 'lambeau-field', 'Green Bay', 'WI', 81441),
  ('v-levis', 'NFL', 'Levi''s Stadium', 'levis-stadium', 'San Francisco', 'CA', 68500),
  ...
  ('v-yankee', 'MLB', 'Yankee Stadium', 'yankee-stadium', 'New York', 'NY', 54251),
  ('v-dodger', 'MLB', 'Dodger Stadium', 'dodger-stadium', 'Los Angeles', 'CA', 56000),
  ('v-citi', 'MLB', 'Citi Field', 'citi-field', 'New York', 'NY', 41922),
  ('v-truist', 'MLB', 'Truist Park', 'truist-park', 'Atlanta', 'GA', 41084),
...
-- ============================================================
-- ADDITIONAL VENUES (completing all team home stadiums)
-- ============================================================
insert into public.venues (id, sport_id, name, slug, city, state, capacity) values
  -- NFL (missing)
  ('v-state-farm',     'NFL', 'State Farm Stadium',        'state-farm-stadium',        'Glendale',      'AZ', 63400),
  ('v-hard-rock',      'NFL', 'Hard Rock Stadium',         'hard-rock-stadium',         'Miami Gardens', 'FL', 65326),
  ('v-highmark',       'NFL', 'Highmark Stadium',          'highmark-stadium',          'Orchard Park',  'NY', 71608),
  ('v-bank-of-america','NFL', 'Bank of America Stadium',   'bank-of-america-stadium',   'Charlotte',     'NC', 73778),
  ('v-paycor',         'NFL', 'Paycor Stadium',            'paycor-stadium',            'Cincinnati',    'OH', 65515),
  ('v-huntington-bank','NFL', 'Huntington Bank Field',     'huntington-bank-field',     'Cleveland',     'OH', 67895),
  ('v-empower',        'NFL', 'Empower Field at Mile High','empower-field',             'Denver',        'CO', 76125),
  ('v-ford',           'NFL', 'Ford Field',                'ford-field',                'Detroit',       'MI', 65000),
  ('v-nrg',            'NFL', 'NRG Stadium',               'nrg-stadium',               'Houston',       'TX', 72220),
  ('v-lucas-oil',      'NFL', 'Lucas Oil Stadium',         'lucas-oil-stadium',         'Indianapolis',  'IN', 67000),
  ('v-everbank',       'NFL', 'EverBank Stadium',          'everbank-stadium',          'Jacksonville',  'FL', 67814),
  ('v-usbank',         'NFL', 'U.S. Bank Stadium',         'us-bank-stadium',           'Minneapolis',   'MN', 66655),
  ('v-caesars-dome',   'NFL', 'Caesars Superdome',         'caesars-superdome',         'New Orleans',   'LA', 73208),
  ('v-raymond-james',  'NFL', 'Raymond James Stadium',     'raymond-james-stadium',     'Tampa',         'FL', 65890),
  ('v-nissan',         'NFL', 'Nissan Stadium',            'nissan-stadium',            'Nashville',     'TN', 69143),
  ('v-northwest',      'NFL', 'Northwest Stadium',         'northwest-stadium',         'Landover',      'MD', 67717),
  -- MLB (missing)
  ('v-loandepot',      'MLB', 'loanDepot park',            'loandepot-park',            'Miami',         'FL', 37446),
  ('v-chase-field',    'MLB', 'Chase Field',               'chase-field',               'Phoenix',       'AZ', 48519),
  ('v-guaranteed-rate','MLB', 'Guaranteed Rate Field',     'guaranteed-rate-field',     'Chicago',       'IL', 40615),
  ('v-gabp',           'MLB', 'Great American Ball Park',  'great-american-ball-park',  'Cincinnati',    'OH', 42319),
  ('v-progressive',    'MLB', 'Progressive Field',         'progressive-field',         'Cleveland',     'OH', 34788),
  ('v-coors',          'MLB', 'Coors Field',               'coors-field',               'Denver',        'CO', 50144),
  ('v-comerica',       'MLB', 'Comerica Park',             'comerica-park',             'Detroit',       'MI', 41297),
  ('v-minute-maid',    'MLB', 'Minute Maid Park',          'minute-maid-park',          'Houston',       'TX', 41168),
  ('v-kauffman',       'MLB', 'Kauffman Stadium',          'kauffman-stadium',          'Kansas City',   'MO', 37903),
  ('v-angel',          'MLB', 'Angel Stadium',             'angel-stadium',             'Anaheim',       'CA', 45481),
  ('v-american-family','MLB', 'American Family Field',     'american-family-field',     'Milwaukee',     'WI', 41900),
  ('v-target-field',   'MLB', 'Target Field',              'target-field',              'Minneapolis',   'MN', 38544),
  ('v-sutter',         'MLB', 'Sutter Health Park',        'sutter-health-park',        'Sacramento',    'CA', 14014),
  ('v-citizens-bank',  'MLB', 'Citizens Bank Park',        'citizens-bank-park',        'Philadelphia',  'PA', 42901),
  ('v-petco',          'MLB', 'Petco Park',                'petco-park',                'San Diego',     'CA', 40209),
  ('v-tmobile-park',   'MLB', 'T-Mobile Park',             't-mobile-park',             'Seattle',       'WA', 47929),
  ('v-tropicana',      'MLB', 'Tropicana Field',           'tropicana-field',           'St. Petersburg','FL', 25000),
  ('v-rogers-centre',  'MLB', 'Rogers Centre',             'rogers-centre',             'Toronto',       'ON', 49286),
  ('v-nationals-park', 'MLB', 'Nationals Park',            'nationals-park',            'Washington',    'DC', 41313),
  -- NBA (missing)
  ('v-barclays',       'NBA', 'Barclays Center',           'barclays-center',           'Brooklyn',      'NY', 17732),
  ('v-spectrum',       'NBA', 'Spectrum Center',           'spectrum-center',           'Charlotte',     'NC', 19077),
  ('v-rocket-mortgage','NBA', 'Rocket Mortgage FieldHouse','rocket-mortgage-fieldhouse','Cleveland',     'OH', 19432),
  ('v-little-caesars', 'NBA', 'Little Caesars Arena',      'little-caesars-arena',      'Detroit',       'MI', 20491),
  ('v-toyota-center',  'NBA', 'Toyota Center',             'toyota-center',             'Houston',       'TX', 18055),
  ('v-gainbridge',     'NBA', 'Gainbridge Fieldhouse',     'gainbridge-fieldhouse',     'Indianapolis',  'IN', 17923),
  ('v-intuit',         'NBA', 'Intuit Dome',               'intuit-dome',               'Inglewood',     'CA', 18000),
  ('v-fedexforum',     'NBA', 'FedExForum',                'fedexforum',                'Memphis',       'TN', 18119),
  ('v-target-center',  'NBA', 'Target Center',             'target-center',             'Minneapolis',   'MN', 19356),
  ('v-smoothie-king',  'NBA', 'Smoothie King Center',      'smoothie-king-center',      'New Orleans',   'LA', 17791),
  ('v-paycom',         'NBA', 'Paycom Center',             'paycom-center',             'Oklahoma City', 'OK', 18203),
  ('v-kia-center',     'NBA', 'Kia Center',                'kia-center',                'Orlando',       'FL', 18846),
  ('v-footprint',      'NBA', 'Footprint Center',          'footprint-center',          'Phoenix',       'AZ', 18422),
  ('v-moda',           'NBA', 'Moda Center',               'moda-center',               'Portland',      'OR', 19980),
  ('v-golden1',        'NBA', 'Golden 1 Center',           'golden-1-center',           'Sacramento',    'CA', 17500),
  ('v-att-center',     'NBA', 'AT&T Center',               'att-center-nba',            'San Antonio',   'TX', 18418),
  ('v-delta',          'NBA', 'Delta Center',              'delta-center',              'Salt Lake City','UT', 18306),
  -- NHL (missing)
  ('v-honda',          'NHL', 'Honda Center',              'honda-center',              'Anaheim',       'CA', 17174),
  ('v-keybank',        'NHL', 'KeyBank Center',            'keybank-center',            'Buffalo',       'NY', 19070),
  ('v-saddledome',     'NHL', 'Scotiabank Saddledome',     'scotiabank-saddledome',     'Calgary',       'AB', 19289),
  ('v-pnc-arena',      'NHL', 'PNC Arena',                 'pnc-arena',                 'Raleigh',       'NC', 18680),
  ('v-nationwide',     'NHL', 'Nationwide Arena',          'nationwide-arena',          'Columbus',      'OH', 18500),
  ('v-rogers-place',   'NHL', 'Rogers Place',              'rogers-place',              'Edmonton',      'AB', 18647),
  ('v-amerant',        'NHL', 'Amerant Bank Arena',        'amerant-bank-arena',        'Sunrise',       'FL', 19250),
  ('v-xcel',           'NHL', 'Xcel Energy Center',        'xcel-energy-center',        'St. Paul',      'MN', 17954),
  ('v-prudential',     'NHL', 'Prudential Center',         'prudential-center',         'Newark',        'NJ', 16514),
  ('v-ubs',            'NHL', 'UBS Arena',                 'ubs-arena',                 'Elmont',        'NY', 17255),
  ('v-canadian-tire',  'NHL', 'Canadian Tire Centre',      'canadian-tire-centre',      'Ottawa',        'ON', 19153),
  ('v-sap',            'NHL', 'SAP Center',                'sap-center',                'San Jose',      'CA', 17562),
  ('v-climate-pledge', 'NHL', 'Climate Pledge Arena',      'climate-pledge-arena',      'Seattle',       'WA', 17100),
  ('v-rogers-arena',   'NHL', 'Rogers Arena',              'rogers-arena',              'Vancouver',     'BC', 18910),
  ('v-canada-life',    'NHL', 'Canada Life Centre',        'canada-life-centre',        'Winnipeg',      'MB', 15321),
  ('v-bridgestone',    'NHL', 'Bridgestone Arena',         'bridgestone-arena',         'Nashville',     'TN', 17159),
  ('v-amalie',         'NHL', 'Amalie Arena',              'amalie-arena',              'Tampa',         'FL', 19092),
  -- MLS (missing)
  ('v-tql',            'MLS', 'TQL Stadium',               'tql-stadium',               'Cincinnati',    'OH', 26000),
  ('v-saputo',         'MLS', 'Stade Saputo',              'stade-saputo',              'Montreal',      'QC', 19619),
  ('v-dicks-sg',       'MLS', 'Dick''s Sporting Goods Park','dicks-sporting-goods-park','Commerce City', 'CO', 18061),
  ('v-lower-com',      'MLS', 'Lower.com Field',           'lower-com-field',           'Columbus',      'OH', 20371),
  ('v-audi',           'MLS', 'Audi Field',                'audi-field',                'Washington',    'DC', 20000),
  ('v-toyota-stadium', 'MLS', 'Toyota Stadium',            'toyota-stadium',            'Frisco',        'TX', 19096),
  ('v-shell',          'MLS', 'Shell Energy Stadium',      'shell-energy-stadium',      'Houston',       'TX', 22039),
  ('v-chase-stadium',  'MLS', 'Chase Stadium',             'chase-stadium',             'Fort Lauderdale','FL', 25000),
  ('v-dignity',        'MLS', 'Dignity Health Sports Park','dignity-health-sports-park','Carson',        'CA', 27000),
  ('v-bmo',            'MLS', 'BMO Stadium',               'bmo-stadium',               'Los Angeles',   'CA', 22000),
  ('v-red-bull-arena', 'MLS', 'Red Bull Arena',            'red-bull-arena',            'Harrison',      'NJ', 25000),
  ('v-exploria',       'MLS', 'Exploria Stadium',          'exploria-stadium',          'Orlando',       'FL', 25500),
  ('v-subaru',         'MLS', 'Subaru Park',               'subaru-park',               'Chester',       'PA', 18500),
  ('v-america-first',  'MLS', 'America First Field',       'america-first-field',       'Sandy',         'UT', 20213),
  ('v-paypal',         'MLS', 'PayPal Park',               'paypal-park',               'San Jose',      'CA', 18000),
  ('v-children-mercy', 'MLS', 'Children''s Mercy Park',   'childrens-mercy-park',      'Kansas City',   'KS', 18467),
  ('v-citypark',       'MLS', 'CityPark',                  'citypark',                  'St. Louis',     'MO', 22500),
  ('v-bmo-field',      'MLS', 'BMO Field',                 'bmo-field',                 'Toronto',       'ON', 30000),
  ('v-bc-place',       'MLS', 'BC Place',                  'bc-place',                  'Vancouver',     'BC', 54500)
